...
all_meshes = {}
for i in range(0,8): #### based on number of dataset
    #this_mesh = pcl.load('/home/ahmad3/PVN3D/pvn3d/datasets/openDR/openDR_dataset/models/obj_'+str(i+1)+'.ply')
    this_mesh = o3d.io.read_point_cloud('/home/akber/PVN3D/pvn3d/datasets/gears/gears_dataset/models/obj_'+str(i+1)+'.ply')
...
for dist in np.arange(0.55,1.05,0.125):
    ...
    for phi in range(35,90,15):
            ...
            for theta in range(0, 360, 15):
                    ...
                    try:
                        ...
                        while rgb_duplicate:
                            ...
                            if sample_num > 0:  #No point checking for the sample 0
                                previous_im = cv2.imread('/home/akber/PVN3D/pvn3d/datasets/gears/gears_dataset/rgb/'+str(sample_num-1)+'.png', -1)
                        ...
                        while depth_duplicate:
                            ...
                            if sample_num > 0:
                                previous_im = cv2.imread('/home/akber/PVN3D/pvn3d/datasets/gears/gears_dataset/depth/'+str(sample_num-1)+'.png', -1)
                ...
                sio.savemat('/home/akber/PVN3D/pvn3d/datasets/gears/gears_dataset/meta/'+str(sample_num)+'-meta.mat',gt_dict)
                ...
                for i in np.argsort(-obj_cam_T[2,3,:]):
                    ...
                    this_mask[this_mask.nonzero()] = 1.05*np.ceil(255*(i+1)/2)   # As per number of object classes of custom dataset
                ...
                cv2.imwrite('/home/akber/PVN3D/pvn3d/datasets/gears/gears_dataset/rgb/'+str(sample_num)+'.png', cv_image)
                cv2.imwrite('/home/akber/PVN3D/pvn3d/datasets/gears/gears_dataset/depth/'+str(sample_num)+'.png',cv_depthImage)
                cv2.imwrite('/home/akber/PVN3D/pvn3d/datasets/gears/gears_dataset/mask/'+str(sample_num)+'.png',obj_mask)
