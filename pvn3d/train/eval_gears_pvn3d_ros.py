...
from datasets.gears.gears_dataset import gears_Dataset
        ...
        for i, data in tqdm.tqdm(
            ...
            while not rospy.is_shutdown():
                ...
                if pose.shape[0]>cls:
                    ...
                    p2ds_rgb = bs_utl.project_p3d(p3d_rgbs, 1 , K = config.intrinsic_matrix['gears'] )
                    #print(p2ds.shape)
...
if __name__ == "__main__":
    ...
    for i in range(0,8):
        corners = np.loadtxt('/home/akber/PVN3D/pvn3d/datasets/gears/gears_object_kps/'+str(i+1)+'/corners.txt')
